...
public static class FlashWindow
{
	...
	public static bool Flash(Form form, uint count)
	{
		if (Win2000OrLater)
		{
			FLASHWINFO pwfi = Create_FLASHWINFO(form.Handle, 3u, count, 0u);
			return FlashWindowEx(ref pwfi);
		}
		return false;
	}
	...
	public static bool Start(Form form)
	{
		if (Win2000OrLater)
		{
			FLASHWINFO pwfi = Create_FLASHWINFO(form.Handle, 3u, uint.MaxValue, 0u);
			return FlashWindowEx(ref pwfi);
		}
		return false;
	}
	...
	public static bool Stop(Form form)
	{
		if (Win2000OrLater)
		{
			FLASHWINFO pwfi = Create_FLASHWINFO(form.Handle, 0u, uint.MaxValue, 0u);
			return FlashWindowEx(ref pwfi);
		}
		return false;
	}
